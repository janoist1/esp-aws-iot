...
#define _LOG_LEVEL_OFF_ 0

#if _LOG_LEVEL_OFF_

#define _LOG_LEVEL_INFO_ 0
#define _LOG_LEVEL_DEBUG_ 0

#else

#define _LOG_LEVEL_INFO_ 1
#define _LOG_LEVEL_DEBUG_ 1
...
#define info(msg)                         \
  {                                       \
    mp_print_str(MP_PYTHON_PRINTER, msg); \
  }
#else
#define info(msg)
#endif

#if _LOG_LEVEL_DEBUG_
#define debug(msg)                        \
  {                                       \
    mp_print_str(MP_PYTHON_PRINTER, msg); \
  }
...
#define AWS_IOT_MQTT_HOST "device.webio.live" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define MAX_THINGNAME_HANDLED_AT_ANY_GIVEN_TIME 1                                                        ///< We could perform shadow action on any thing Name and this is maximum Thing Names we can act on at any given time
